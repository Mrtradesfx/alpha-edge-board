  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      for (let i = 1; i < 4; i++) {
        ...
        ctx.beginPath();
        ctx.ellipse(centerX, y, radius * Math.sin(i * Math.PI / 4), radius * 0.2, 0, 0, 2 * Math.PI);
        ctx.stroke();
      }
      ...
      for (let i = 0; i < 6; i++) {
        ...
        ctx.beginPath();
        ctx.ellipse(centerX, centerY, radius * Math.cos(angle), radius, angle, 0, 2 * Math.PI);
        ctx.stroke();
      }
  ...
  useEffect(() => {
    ...
    const resizeCanvas = () => {
      ...
      if (container) {
        ...
        canvas.height = Math.min(container.clientWidth * 0.8, 300);
      }
    };
      ...
      <CardContent className="pt-0 p-3 sm:p-6">
        <div className="relative">
          <canvas
            ...
            style={{ background: 'radial-gradient(circle, rgba(15, 23, 42, 0.8) 0%, rgba(15, 23, 42, 0.9) 100%)' }}
          />
